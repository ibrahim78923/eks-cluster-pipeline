...
exports.sendEmailParent = async (emailTo,subject,name,id,password,schoolName,schoolImg) =>  {
    //send email
    if(emailTo){
                                      ...
                                      <table align="center">
                                         ...
                                         <tr>
                                            <td align="center">
                                               <p
                                                  ...
                                                  align="center"
                                                  >
                                                  Your school (${schoolName}) and Ezpick work together to provide
                                                  <br />
                                                  parents a hassle-free way to pick up their children.
                                               </p>
                                            </td>
                                         </tr>
                                         <tr>
                                         ...
                                         <tr>
                                           ...
                                           <tr>
                                            <td align="center">
                                              <a
                                                href="https://apps.apple.com/sa/app/ezpick-student-pick-up-system/id1673235177"
                                                target="_blank"
                                              ...
                                              >
                                                <img
                                                  ...
                                                  alt="Logo appstore"
                                                  style="margin-right: 15px; margin-top: 2%;width: 30%;"
                                                />
                                              </a>
                                              <a
